...
export type CreateRoomMutation = { __typename?: 'Mutation', createRoom: { __typename?: 'Room', id: any, name: string, groupId: any, orderIndex: number, type: string } };
...
export type RoomsGroupsQuery = { __typename?: 'Query', roomsGroups: Array<{ __typename?: 'RoomsGroup', id: any, name: string, orderIndex: number, serverId: any, rooms: Array<{ __typename?: 'Room', id: any, name: string, groupId: any, orderIndex: number, type: string }> }> };

export type CreateRoomsGroupMutationVariables = Exact<{
  input: CreateRoomsGroupInput;
}>;


export type CreateRoomsGroupMutation = { __typename?: 'Mutation', createRoomsGroup: { __typename?: 'RoomsGroup', id: any, name: string, orderIndex: number, serverId: any } };
...
export const CreateRoomsGroupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateRoomsGroup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateRoomsGroupInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createRoomsGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"orderIndex"}},{"kind":"Field","name":{"kind":"Name","value":"serverId"}}]}}]}}]} as unknown as DocumentNode<CreateRoomsGroupMutation, CreateRoomsGroupMutationVariables>;
